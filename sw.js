const CACHE='mv-indoor-route-v3';
const ASSETS=['./','index.html','styles.css','app.js','manifest.webmanifest','data/places.seed.json','data/route-topology.json','data/connected-facilities.json'];
